...
- generic [ref=e2]:
  ...
  - generic [ref=e363]:
    - generic [ref=e364]: ⚠️
    - generic [ref=e365]: "Compilation error: A component has an unconnected pin — check that every pin sits exactly on a wire endpoint. Rotated or moved components often leave pins dangling. Components in circuit: Vcc, Vtrig, R1, Rg, T1, SW, Ground, Ground, Ground, P1."
    - button "×" [ref=e366] [cursor=pointer]
    - button "100%" [ref=e368] [cursor=pointer]
    - generic [ref=e369]: 22, 8
```