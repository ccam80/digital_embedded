...
- **Engine contract**: spec/setup-load-split/00-engine.md (ssA2 SetupContext, ssA6 factory)
...
- **Notes for agent:**
  - Both NFET and PFET are composites that decompose to a single SW
    sub-element (PB-NFET ss"Sub-element decomposition"). The composite's
...
- **PB specs:**
  ...
  - `PB-SCHMITT.md`
- **Notes for agent:**
  - PB-OPAMP ss"Default rOut=75- behavioral change warning" is critical:
