...
- `BehavioralGateElement` adds a `setup(ctx: SetupContext): void` method per Shape rule 3. This method is shared by all gate variants (NOT, AND, NAND, OR, NOR, XOR, XNOR) since they all use `BehavioralGateElement`.
