...
**ngspice anchor:** NONE- behavioral. Ground is a node-zero sentinel with no matrix entries and no state. setup() body is empty (per 02-behavioral.md ssBehavioral element list, Ground row).
