...
1. `setup-stamp-order.test.ts` row for PB-CCVS is GREEN: insertion order must be
   `[(posNode, ownBranch), (negNode, ownBranch), (ownBranch, negNode),
     (ownBranch, posNode), (ownBranch, contBranch)]`
