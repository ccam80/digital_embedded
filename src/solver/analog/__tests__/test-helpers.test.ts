...
describe("mock_factory", () => {
  it("returns_load_ctx_interface", () => {
    ...
    expect((mock as unknown as Record<string, unknown>)["stamp"]).toBeUndefined();
    expect((mock as unknown as Record<string, unknown>)["stampNonlinear"]).toBeUndefined();
    expect((mock as unknown as Record<string, unknown>)["updateOperatingPoint"]).toBeUndefined();
  });
