 ...
 * each input against per-instance vIH / vIL, and writes the OR-reduced
...
export class BehavioralOrDriverElement extends AbstractPoolBackedAnalogElement {
   ...
   *
   *   - If any input rises above vIH (a "1" for OR) -> output 1 immediately;
   *     1 is the absorbing element for OR so further inputs do not matter.
