...
const CMOS_XNOR2_NETLIST: MnaSubcircuitNetlist = {
  ...
  elements: [
    ...
    { typeId: "PMOS", modelRef: "spice-l1", branchCount: 0, params: { W: "WP", L: "L" } }, // inv_out_p: output inverter PMOS
    { typeId: "NMOS", modelRef: "spice-l1", branchCount: 0, params: { W: "WN", L: "L" } }, // inv_out_n: output inverter NMOS
  ],
  internalNetCount: 3,
