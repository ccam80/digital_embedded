...
function makeNJfetAt(
  ...
  const element = createNJfetElement(new Map([["G", nodeG], ["S", nodeS], ["D", nodeD]]), -1, propsObj as unknown as PropertyBag) as NJfetAnalogElement;
...
describe("NJFET", () => {
  it("cutoff_zero_current", () => {
    ...
    const element = createNJfetElement(new Map([["G", 1], ["S", 0], ["D", 2]]), -1, propsObj as unknown as PropertyBag);
  ...
  it("saturation_current", () => {
    ...
    const propsObj = { _modelParams: params };
    const element = createNJfetElement(new Map([["G", 1], ["S", 0], ["D", 2]]), -1, propsObj as unknown as PropertyBag) as NJfetAnalogElement;
...
describe("PJFET", () => {
  it("polarity_inverted", () => {
    ...
    const propsObj = { _modelParams: PJFET_PARAMS };
    const element = createPJfetElement(new Map([["G", 1], ["D", 2], ["S", 3]]), -1, propsObj as unknown as PropertyBag);
