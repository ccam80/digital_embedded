 ...
 * comment names `architectural-alignment.md ssE1` so that a reader arriving at
...
describe("BJT L0 scope documentation", () => {
  it("documents L0 substrate divergence after pnjlim block", () => {
    ...
    // Production source contains mojibake encoding of ss: "Âss" instead of "ss".
    ...
    const expectedCitation = "architectural-alignment.md ÂssE1";
