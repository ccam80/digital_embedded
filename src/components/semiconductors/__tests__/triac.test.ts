...
function makeTriac(overrides: Partial<typeof TRIAC_DEFAULTS> = {}): AnalogElement {
  ...
  return createTriacElement([1, 2, 3], -1, params as unknown as PropertyBag);
}
...
describe("Triac", () => {
  ...
  it("definition_has_correct_fields", () => {
    ...
    expect(TriacDefinition.engineType).toBe("analog");
    expect(TriacDefinition.analogDeviceType).toBe("TRIAC");
    expect(TriacDefinition.analogFactory).toBeDefined();
