...
export const RELAY_DT_NETLIST: MnaSubcircuitNetlist = {
  ...
  elements: [
    ...
    { typeId: "Switch",        modelRef: "default", subElementName: "contactNO",                   params: { Ron: "Ron", Roff: "Roff" } },
    { typeId: "Switch",        modelRef: "default", subElementName: "contactNC",                   params: { Ron: "Ron", Roff: "Roff" } },
    { typeId: "RelayCoupling", modelRef: "default", subElementName: "couplingNO",
      params: {
        coilBranch:   { kind: "siblingBranch", subElementName: "coilL" },
        switchClosed: { kind: "siblingState",  subElementName: "contactNO", slotName: "CLOSED" },
        pullInI:  "pullInI",
        dropOutI: "dropOutI",
      } },
    { typeId: "RelayCoupling", modelRef: "default", subElementName: "couplingNC",
      params: {
        coilBranch:   { kind: "siblingBranch", subElementName: "coilL" },
        switchClosed: { kind: "siblingState",  subElementName: "contactNC", slotName: "CLOSED" },
        pullInI:  "dropOutI",
        dropOutI: "pullInI",
      } },
  ],
...
export const RelayDTDefinition: StandaloneComponentDefinition = {
  name: "RelayDT",
  typeId: -1,
