...
export const RELAY_DT_NETLIST: MnaSubcircuitNetlist = {
  ...
  elements: [
    ...
    { typeId: "CurrentControlledSwitch", modelRef: "default",    subElementName: "contactNO",
      params: {
        Ron: "Ron",
        Roff: "Roff",
    ...
    { typeId: "CurrentControlledSwitch", modelRef: "default",    subElementName: "contactNC",
      params: {
        Ron: "Ron",
        Roff: "Roff",
        ctrlBranch: { kind: "ref", name: "coilSense" },
