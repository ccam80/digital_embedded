...
export const { paramDefs: FGPFET_PARAM_DEFS, defaults: FGPFET_PARAM_DEFAULTS } = defineModelParams({
  primary: {
    ...
    KP:     { default: MOSFET_PMOS_DEFAULTS.KP,     unit: "A/V²",   description: "Process transconductance parameter" },
  ...
  secondary: {
    ...
    RD:     { default: MOSFET_PMOS_DEFAULTS.RD,     unit: "Ω",      description: "Drain ohmic resistance" },
    RS:     { default: MOSFET_PMOS_DEFAULTS.RS,     unit: "Ω",      description: "Source ohmic resistance" },
