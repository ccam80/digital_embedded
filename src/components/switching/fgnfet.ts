...
export const { paramDefs: FGNFET_PARAM_DEFS, defaults: FGNFET_PARAM_DEFAULTS } = defineModelParams({
  primary: {
    ...
    KP:     { default: MOSFET_NMOS_DEFAULTS.KP,     unit: "A/V²",   description: "Process transconductance parameter" },
  ...
  secondary: {
    ...
    RD:     { default: MOSFET_NMOS_DEFAULTS.RD,     unit: "Ω",      description: "Drain ohmic resistance" },
    RS:     { default: MOSFET_NMOS_DEFAULTS.RS,     unit: "Ω",      description: "Source ohmic resistance" },
